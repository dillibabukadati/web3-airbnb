...
contract airbnb {
    ...
    function addDatesBooked(uint256 id, string[] memory newBookings) public returns (bool){
        ...
        console.log(airbnbToken.totalSupply());
        console.log(airbnbToken.balanceOf(msg.sender));
        airbnbToken.transferFrom(msg.sender,owner,rentals[id].pricePerDay);
